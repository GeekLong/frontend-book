...
const apiObj = {
  ...
  API_POST_RE_CONFIG: prefix + '/reconfig', 
  API_POST_RE_CON_LIST: prefix + '/conlist',
  API_POST_RE_GROUP: prefix + '/regroup'
};

const apiFuncObj = {
  getPower: 'API_GET_POWER', // 获取用户信息
  reConfig: 'API_POST_RE_CONFIG',
  reConList: 'API_POST_RE_CON_LIST',
  reGroup: 'API_POST_RE_GROUP'
};
